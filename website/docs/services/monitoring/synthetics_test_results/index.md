...
Creates, updates, deletes, gets or lists a <code>synthetics_test_results</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="synthetics_test_results" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="datadog.monitoring.synthetics_test_results" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_synthetics_test_result"
    values={[
        { label: 'get_synthetics_test_result', value: 'get_synthetics_test_result' },
        { label: 'list_synthetics_test_latest_results', value: 'list_synthetics_test_latest_results' }
    ]}
>
<TabItem value="get_synthetics_test_result">
...
<TabItem value="list_synthetics_test_latest_results">
...
<tbody>
<tr>
    <td><a href="#get_synthetics_test_result"><CopyableCode code="get_synthetics_test_result" /></a></td>
    ...
    <td>Get a specific full result from a given Synthetic test.</td>
</tr>
<tr>
    <td><a href="#list_synthetics_test_latest_results"><CopyableCode code="list_synthetics_test_latest_results" /></a></td>
    <td><CopyableCode code="select" /></td>
    ...
    <td>Get the latest result summaries for a given Synthetic test.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-public_id">
    ...
    <td><code>string</code></td>
    <td>The public ID of the Synthetic test for which to search results.</td>
</tr>
...
relationships,
type
FROM datadog.monitoring.synthetics_test_results
