--- 
title: synthetics_browser_test_results
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>synthetics_browser_test_results</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="synthetics_browser_test_results" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="datadog.monitoring.synthetics_browser_test_results" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_browser_test_result"
    values={[
        { label: 'get_browser_test_result', value: 'get_browser_test_result' },
        { label: 'get_browser_test_latest_results', value: 'get_browser_test_latest_results' }
    ]}
>
<TabItem value="get_browser_test_result">
...
<tr>
    ...
    <td>ID of the browser test result.</td>
</tr>
<tr>
    <td><CopyableCode code="check" /></td>
    <td><code>object</code></td>
    <td>Object describing the browser test configuration.</td>
</tr>
<tr>
    <td><CopyableCode code="check_time" /></td>
    <td><code>number (double)</code></td>
    <td>When the browser test was conducted.</td>
</tr>
<tr>
    <td><CopyableCode code="check_version" /></td>
    <td><code>integer (int64)</code></td>
    <td>Version of the browser test used.</td>
</tr>
<tr>
    <td><CopyableCode code="probe_dc" /></td>
    <td><code>string</code></td>
    <td>Location from which the browser test was performed.</td>
</tr>
<tr>
    <td><CopyableCode code="result" /></td>
    <td><code>object</code></td>
    <td>Object containing results for your Synthetic browser test.</td>
</tr>
<tr>
...
<TabItem value="get_browser_test_latest_results">
...
<tr>
    <td><CopyableCode code="check_time" /></td>
    <td><code>number (double)</code></td>
    <td>Last time the browser test was performed.</td>
</tr>
<tr>
    <td><CopyableCode code="probe_dc" /></td>
    <td><code>string</code></td>
...
<tr>
    <td><CopyableCode code="result" /></td>
    <td><code>object</code></td>
    <td>Object with the result of the last browser test run.</td>
</tr>
<tr>
    <td><CopyableCode code="status" /></td>
    <td><code>integer (int64)</code></td>
...
<tbody>
<tr>
    <td><a href="#get_browser_test_result"><CopyableCode code="get_browser_test_result" /></a></td>
...
<tr>
    <td><a href="#get_browser_test_latest_results"><CopyableCode code="get_browser_test_latest_results" /></a></td>
    <td><CopyableCode code="select" /></td>
    ...
    <td>Get the last 150 test results summaries for a given Synthetic browser test.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-public_id">
    ...
    <td><code>string</code></td>
    <td>The public ID of the browser test for which to search results for.</td>
</tr>
