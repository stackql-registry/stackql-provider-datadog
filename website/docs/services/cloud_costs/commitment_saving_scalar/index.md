--- 
title: commitment_saving_scalar
hide_title: false
hide_table_of_contents: false
keywords:
  - commitment_saving_scalar
  - cloud_costs
  - datadog
...
Creates, updates, deletes, gets or lists a <code>commitment_saving_scalar</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="commitment_saving_scalar" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="datadog.cloud_costs.commitment_saving_scalar" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_commitments_savings_scalar"
    values={[
        { label: 'get_commitments_savings_scalar', value: 'get_commitments_savings_scalar' }
    ]}
>
<TabItem value="get_commitments_savings_scalar">
...
<tbody>
<tr>
    <td><a href="#get_commitments_savings_scalar"><CopyableCode code="get_commitments_savings_scalar" /></a></td>
    ...
    <td>Get scalar savings metrics for cloud commitment programs, including realized savings and effective savings rate.</td>
</tr>
</tbody>
</table>
...
type,
values
FROM datadog.cloud_costs.commitment_saving_scalar
