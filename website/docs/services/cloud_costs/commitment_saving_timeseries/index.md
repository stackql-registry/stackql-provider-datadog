--- 
title: commitment_saving_timeseries
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>commitment_saving_timeseries</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="commitment_saving_timeseries" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="datadog.cloud_costs.commitment_saving_timeseries" /></td></tr>
</tbody></table>
...
<Tabs
    defaultValue="get_commitments_savings_timeseries"
    values={[
        { label: 'get_commitments_savings_timeseries', value: 'get_commitments_savings_timeseries' }
    ]}
>
<TabItem value="get_commitments_savings_timeseries">
...
<tbody>
<tr>
    <td><CopyableCode code="actual_cost" /></td>
    <td><code>object</code></td>
    <td>A timeseries metric containing timestamps, series values, and optional unit metadata.</td>
</tr>
<tr>
    <td><CopyableCode code="effective_savings_rate" /></td>
    <td><code>object</code></td>
    <td>A timeseries metric containing timestamps, series values, and optional unit metadata.</td>
</tr>
<tr>
    <td><CopyableCode code="on_demand_equivalent_cost" /></td>
    <td><code>object</code></td>
    <td>A timeseries metric containing timestamps, series values, and optional unit metadata.</td>
</tr>
<tr>
    <td><CopyableCode code="realized_savings" /></td>
    <td><code>object</code></td>
    <td>A timeseries metric containing timestamps, series values, and optional unit metadata.</td>
</tr>
</tbody>
...
<tbody>
<tr>
    <td><a href="#get_commitments_savings_timeseries"><CopyableCode code="get_commitments_savings_timeseries" /></a></td>
    ...
    <td>Get timeseries savings metrics for cloud commitment programs, including actual cost, on-demand equivalent cost, realized savings, and effective savings rate over time.</td>
</tr>
</tbody>
</table>
